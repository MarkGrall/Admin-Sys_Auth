...
import { Button,Card,Col, CardBody,Form,FormGroup,Label,Input,CustomInput, 
Row,Nav, NavItem, NavLink,TabContent,TabPane} from "reactstrap";
...
const SignInForm = withAuth(class LoginForm extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      sessionToken: null,
